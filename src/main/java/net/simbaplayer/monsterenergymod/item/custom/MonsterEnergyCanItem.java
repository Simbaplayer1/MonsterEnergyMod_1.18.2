...
public class MonsterEnergyCanItem extends Item {
    public MonsterEnergyCanItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!list.isEmpty()) {
            ...
            return TypedActionResult.success(this.fill(itemStack, user, new ItemStack(ModItems.DRAGON_BREATH_MONSTER_CAN)), world.isClient());
        }
        ...
        if (((HitResult)hitResult).getType() == HitResult.Type.BLOCK) {
            ...
            if (world.getFluidState(blockPos).isIn(FluidTags.WATER)) {
                ...
                return TypedActionResult.success(this.fill(itemStack, user, PotionUtil.setPotion(new ItemStack(ModItems.WATER_FILLED_MONSTER_CAN), Potions.WATER)), world.isClient());
            }
